...
const Footer = () => {
    return (
        <footer className="footer footer-center bg-gradient-to-r from-blue-500 to-orange-400 text-white py-6">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="text-center mb-4">
                    ...
                    <p className="text-xs mt-2">Copyright © {new Date().getFullYear()} - All rights reserved</p>
                </div>
